        ...
        <div className={`fixed inset-0 z-[100] flex items-center justify-center px-4 overflow-hidden transition-all duration-500 ${isOpen && animate ? 'visible' : 'invisible'}`}>
            ...
            >
                ...
                <div className="p-8 md:p-12 relative z-10">
                    ...
                    <button 
                        onClick={onClose}
                        className="absolute top-6 right-6 rtl:right-auto rtl:left-6 text-gray-400 hover:text-gray-600 transition-colors p-2 bg-gray-50 rounded-full"
                    >
                    ...
                    <div className="text-center mb-10">
                        <div className="inline-flex items-center justify-center p-4 bg-blue-50 rounded-[28px] mb-4 shadow-inner">
                            <img src="/Logo.png" alt="Logo" className="h-10 w-auto" />
                        </div>
                        <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-2 tracking-tight">{t.title}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                        ...
                        <a 
                            ...
                            className="group flex flex-col items-center text-center p-8 rounded-[35px] bg-gray-50 border-2 border-transparent hover:border-blue-600 hover:bg-white transition-all duration-300 transform hover:-translate-y-1 shadow-sm hover:shadow-xl"
                        >
                            <div className="w-16 h-16 bg-black rounded-2xl flex items-center justify-center text-white shadow-lg mb-6 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <h4 className="text-xl font-bold text-gray-900 mb-2">{t.ios.title}</h4>
                            <p className="text-sm text-gray-400 leading-relaxed mb-6 flex-grow">{t.ios.desc}</p>
                            <div className="w-full py-3 bg-blue-600 text-white rounded-2xl text-sm font-bold shadow-md transform group-hover:scale-105 transition-all">
                                {t.ios.btn}
                            </div>
                        </a>
                        ...
                        <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group flex flex-col items-center text-center p-8 rounded-[35px] bg-gray-50 border-2 border-transparent hover:border-[#34A853] hover:bg-white transition-all duration-300 transform hover:-translate-y-1 shadow-sm hover:shadow-xl"
                        >
                            <div className="w-16 h-16 bg-[#F1F3F4] rounded-2xl flex items-center justify-center shadow-lg mb-6 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <h4 className="text-xl font-bold text-gray-900 mb-2">{t.android.title}</h4>
                            <p className="text-sm text-gray-400 leading-relaxed mb-6 flex-grow">{t.android.desc}</p>
                            <div className="w-full py-3 bg-[#34A853] text-white rounded-2xl text-sm font-bold shadow-md transform group-hover:scale-105 transition-all">
                                {t.android.btn}
                            </div>
                        </a>
